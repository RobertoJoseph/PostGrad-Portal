                                            ...
                                            {courses.map((item, index) => {
                                                return (
                                                    <tr key={index} align="center">
                                                        ...
                                                        <td>{item.fees}</td>
                                                        <td>{(item.grade) ? (item.grade) : (
                                                            <Button color="success" onClick={addGradeButton(item.id)}>Add Grade</Button>
                                                        ) }</td>
                                                    </tr>
                                                );
                                            })}
                ...
                <Modal centered isOpen={isModalOpen} toggle={setTheModal}>
                    ...
                    <ModalBody>
                        <Form onSubmit={handleSubmit(linkCourse)}>
                            <FormGroup >
                                <Row>
                                    <Label htmlFor="course" className="col-3">Select Course</Label>
                                    <Col md={9}>
                                        <select
                                            id="course"
                                            name="course"
                ...
                <Modal centered isOpen={isGradeModalOpen} toggle={setTheGradeModal}>
                    ...
                    <ModalBody>
                        <Form onSubmit={handleSubmit(addGrade)}>
                            <FormGroup >
                                <Row>
                                    <Label htmlFor="grade" className="col-3">Grade</Label>
                                    <Col md={9}>
                                        <input
                                            id="grade"
                                            name="grade"
